		...
		implements SensorEventListener, LocationListener
{
	...
	static final int    REQUEST_CAMERA_PERMISSIONS_CODE   = 11;
	static final int    REQUEST_LOCATION_PERMISSIONS_CODE = 0;
	static final long   MIN_DISTANCE_CHANGE_FOR_UPDATES   = 0; // 10 meters
	static final long   MIN_TIME_BW_UPDATES               = 0;//1000 * 60 * 1; // 1 minute
	...
	public void onSensorChanged(SensorEvent sensorEvent)
	{
		if (sensorEvent.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR)
		{
			...
			Matrix.multiplyMM(rotatedProjectionMatrix, 0, projectionMatrix, 0,
							  rotationMatrixFromVector, 0);
	...
	private void initLocationService()
	{
		...
		try
		{
			...
			this.isNetworkEnabled = locationManager.isProviderEnabled(
