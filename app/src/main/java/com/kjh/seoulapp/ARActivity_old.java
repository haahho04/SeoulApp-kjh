...
public class ARActivity_old extends AppCompatActivity
    implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (ContextCompat.checkSelfPermission(ARActivity_old.this, android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED)
			ActivityCompat.requestPermissions(ARActivity_old.this, new String[]{android.Manifest.permission.CAMERA}, CAM_PERMISSION_REQUEST);
		else
			openCam();
    }
    ...
    public void onClick(View view)
    {
        ...
        switch (id)
        {
			case R.id.btn_get_stamp:
				sendStampInfo();
				Intent intent = new Intent(ARActivity_old.this, TourRegionActivity.class);
